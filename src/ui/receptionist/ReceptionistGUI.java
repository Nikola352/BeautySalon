...
public class ReceptionistGUI extends GUI {
    ...
    public ReceptionistGUI(Receptionist user, LogoutCallback logoutCallback) {
        ...
        setTitle("Recepcioner - " + user.getName() + " " + user.getLastname() + " (" + user.getUsername() + ")");
        setSize(1200, 600);
    ...
    private void setupLayout() {
        ...
        panel.setLayout(new MigLayout("wrap 2, center", "[center, grow]30[center, grow]", "[]30[bottom, grow]"));
        ...
        rightPanel.setLayout(new MigLayout("wrap 1, center", "[center, grow]", "[]30[][]10[][]10[][]10[][]10[][]10[][]30[][]"));
        ...
        panel.add(leftPanel, "span 1 2, grow");
        panel.add(rightPanel, "span 1 2, grow");
